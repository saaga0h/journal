...
BRIEF_TREND_MANIFOLDS={{ .Data.data.BRIEF_TREND_MANIFOLDS }}
BRIEF_TREND_CHUNKS={{ .Data.data.BRIEF_TREND_CHUNKS }}
BRIEF_UNEXPECTED_VECTORS={{ .Data.data.BRIEF_UNEXPECTED_VECTORS }}
{{ end }}
EOT
      }
